...
.field static final DAIL_NUMBER:Ljava/lang/String; = null
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 268
    const-string/jumbo v0, "ro.config.hw_ota_num"
    ...
    sput-object v0, Lcom/android/internal/telephony/RIL;->DAIL_NUMBER:Ljava/lang/String;
...
.method private addQcrilRequestHeader(Ljava/nio/ByteBuffer;II)V
    .locals 1
    .parameter "buf"
    .parameter "requestId"
...
.method private getQcrilRequestHeader(I)[B
    .locals 3
    .parameter "requestId"

    .prologue
    .line 1951
    sget v2, Lcom/android/internal/telephony/RILConstants;->OEM_HOOK_RAW_REQUEST_HEADERSIZE:I
    ...
    invoke-direct {p0, v0, p1, v2}, Lcom/android/internal/telephony/RIL;->addQcrilRequestHeader(Ljava/nio/ByteBuffer;II)V
...
.method private processUnsolOemhookResponse(Ljava/nio/ByteBuffer;)V
    ...
    .line 3287
    .local v9, QCRILHOOK_UNSOL_EXTENDED_DBM_INTL:I
    const v5, 0x803e9
    ...
    .line 3294
    .local v3, HW_QCRILHOOK_BASE:I
    const v8, 0x807d1

    .line 3296
    .local v8, QCRILHOOK_UNSOL_DIALUP_STATE:I
    const/4 v13, 0x0
    ...
    const-string v18, "Response ID in RIL_UNSOL_OEM_HOOK_RAW is "
    ...
    const-string v18, "Response Size is Invalid "
    ...
    invoke-virtual {v0, v12, v1, v14}, Ljava/nio/ByteBuffer;->get([BII)Ljava/nio/ByteBuffer;
    ...
    const-string v18, "is not served in this process."
    ...
    const-string v17, "To broadcast an Intent via the notifier to external apps"
    ...
    invoke-virtual/range {v16 .. v17}, Landroid/os/Registrant;->notifyRegistrant(Landroid/os/AsyncResult;)V

    goto :goto_0

    .line 3311
    .end local v10           #origData:[B
    :sswitch_0
    move-object/from16 v0, p0

    invoke-virtual {v0, v12}, Lcom/android/internal/telephony/RIL;->notifyCdmaFwdBurstDtmf([B)V
    ...
    invoke-virtual {v0, v12}, Lcom/android/internal/telephony/RIL;->notifyCdmaFwdContDtmfStart([B)V
    ...
    const-string/jumbo v18, "maning:stop service state = "
...
.method private responseIccCardStatus(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    iput v4, v3, Lcom/android/internal/telephony/IccCardStatus;->mGsmUmtsSubscriptionAppIndex:I
    ...
    iput v4, v3, Lcom/android/internal/telephony/IccCardStatus;->mCdmaSubscriptionAppIndex:I
    ...
    iput v4, v3, Lcom/android/internal/telephony/IccCardStatus;->mImsSubscriptionAppIndex:I
    ...
    .line 3518
    :cond_0
    new-array v4, v2, [Lcom/android/internal/telephony/IccCardApplicationStatus;

    iput-object v4, v3, Lcom/android/internal/telephony/IccCardStatus;->mApplications:[Lcom/android/internal/telephony/IccCardApplicationStatus;
    ...
    .line 3521
    .local v0, ca:Lcom/android/internal/telephony/IccCardApplicationStatus;
    invoke-virtual {p1}, Landroid/os/Parcel;->readInt()I
    ...
    .line 3529
    iget-object v4, v3, Lcom/android/internal/telephony/IccCardStatus;->mApplications:[Lcom/android/internal/telephony/IccCardApplicationStatus;
    ...
    .line 3531
    .end local v0           #ca:Lcom/android/internal/telephony/IccCardApplicationStatus;
    :cond_1
    return-object v3
.end method
...
.method private responseSignalStrength(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p1, v1}, Landroid/telephony/SignalStrength;-><init>(Landroid/os/Parcel;Z)V
...
.method public dial(Ljava/lang/String;ILandroid/os/Message;)V
    ...
    sget-object v1, Lcom/android/internal/telephony/RIL;->DAIL_NUMBER:Ljava/lang/String;
    ...
    .line 961
    sget-object v0, Lcom/android/internal/telephony/RIL;->DAIL_NUMBER:Ljava/lang/String;

    invoke-virtual {p0, v0, p2, v2, p3}, Lcom/android/internal/telephony/RIL;->dial(Ljava/lang/String;ILcom/android/internal/telephony/UUSInfo;Landroid/os/Message;)V
    ...
    .line 963
    :cond_0
    invoke-virtual {p0, p1, p2, v2, p3}, Lcom/android/internal/telephony/RIL;->dial(Ljava/lang/String;ILcom/android/internal/telephony/UUSInfo;Landroid/os/Message;)V
...
.method public getCurrentArm0CdmaFreq(Landroid/os/Message;)V
    ...
    invoke-direct {p0, v1}, Lcom/android/internal/telephony/RIL;->getQcrilRequestHeader(I)[B

    move-result-object v0

    .line 1946
    .local v0, headerData:[B
    invoke-virtual {p0, v0, p1}, Lcom/android/internal/telephony/RIL;->invokeOemRilRequestRaw([BLandroid/os/Message;)V
...
.method public writeSmsToRuim(ILjava/lang/String;Landroid/os/Message;)V
    ...
    const-string/jumbo v13, "writeSmsToRuim pdu is"
    ...
    const-string/jumbo v12, "writeSmsToRuim: UnsupportedEncodingException: "
    ...
    const-string/jumbo v12, "writeSmsToRuim: conversion from input stream to object failed: "
