...
.field private mNetSeletct:Lcom/android/internal/telephony/HWNetSelect;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/internal/telephony/CardSubscriptionManager;->mPowerOnSetsub:[Z
...
.method private constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/UiccManager;[Lcom/android/internal/telephony/CommandsInterface;)V
    ...
    .line 133
    iput v6, p0, Lcom/android/internal/telephony/CardSubscriptionManager;->mUpdateUiccStatusContext:I
    ...
    .line 142
    iput-boolean v6, p0, Lcom/android/internal/telephony/CardSubscriptionManager;->mAllCardsInfoAvailable:Z

    .line 145
    iput-object v5, p0, Lcom/android/internal/telephony/CardSubscriptionManager;->mNetSeletct:Lcom/android/internal/telephony/HWNetSelect;
    ...
    invoke-virtual {v2, p0, v4, v5}, Lcom/android/internal/telephony/UiccManager;->registerForIccChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-direct {v3, p0, v5}, Lcom/android/internal/telephony/CardSubscriptionManager$CardInfo;-><init>(Lcom/android/internal/telephony/CardSubscriptionManager;Lcom/android/internal/telephony/UiccCard;)V
    ...
    .line 192
    :cond_2
    invoke-static {p1}, Lcom/android/internal/telephony/HWNetSelect;->getInstance(Landroid/content/Context;)Lcom/android/internal/telephony/HWNetSelect;

    move-result-object v2

    iput-object v2, p0, Lcom/android/internal/telephony/CardSubscriptionManager;->mNetSeletct:Lcom/android/internal/telephony/HWNetSelect;
...
.method private declared-synchronized onUpdateUiccStatus(Ljava/lang/Integer;Ljava/lang/String;)V
    ...
    const-string/jumbo v19, "onUpdateUiccStatus: cardIndex = "
    ...
    invoke-direct {v0, v1}, Lcom/android/internal/telephony/CardSubscriptionManager;->logd(Ljava/lang/String;)V
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/CardSubscriptionManager;->mUiccCardList:Ljava/util/ArrayList;
    ...
    check-cast v5, Lcom/android/internal/telephony/CardSubscriptionManager$CardInfo;

    .line 476
    .local v5, cardInfo:Lcom/android/internal/telephony/CardSubscriptionManager$CardInfo;
    const/4 v15, 0x0
    ...
    .line 481
    invoke-virtual {v5}, Lcom/android/internal/telephony/CardSubscriptionManager$CardInfo;->getUiccCard()Lcom/android/internal/telephony/UiccCard;
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/CardSubscriptionManager;->mRadioOn:[Z
    ...
    const-string/jumbo v19, "onUpdateUiccStatus(): mRadioOn["
    ...
    const-string/jumbo v19, "onUpdateUiccStatus(): NO Card!!!!! at index : "
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/CardSubscriptionManager;->mCardSubData:[Lcom/android/internal/telephony/SubscriptionData;
    ...
    sget-object v19, Lcom/android/internal/telephony/CardSubscriptionManager;->mPowerOnSetsub:[Z
    ...
    sget-object v18, Lcom/android/internal/telephony/CardSubscriptionManager;->mPowerOnSetsub:[Z
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/internal/telephony/SubscriptionManager;->getUserSubInfo()Lcom/android/internal/telephony/SubscriptionData;

    move-result-object v17

    .line 567
    .local v17, usersub:Lcom/android/internal/telephony/SubscriptionData;
    invoke-static {}, Lcom/android/internal/telephony/SubscriptionManager;->getInstance()Lcom/android/internal/telephony/SubscriptionManager;

    move-result-object v18

    invoke-virtual/range {v18 .. v18}, Lcom/android/internal/telephony/SubscriptionManager;->getLastIccidInfo()[Ljava/lang/String;

    move-result-object v11

    .line 568
    .local v11, lastIccid:[Ljava/lang/String;
    const-string/jumbo v18, "try to match!"
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/CardSubscriptionManager;->mNetSeletct:Lcom/android/internal/telephony/HWNetSelect;
    ...
    invoke-virtual {v0, v1, v2, v11, v3}, Lcom/android/internal/telephony/HWNetSelect;->matchSubscriptions(Lcom/android/internal/telephony/SubscriptionData;[Lcom/android/internal/telephony/SubscriptionData;[Ljava/lang/String;I)Z
    ...
    .line 572
    const-string/jumbo v18, "use our default activate process!"
    ...
    .end local v17           #usersub:Lcom/android/internal/telephony/SubscriptionData;
    :cond_4
    :goto_1
    monitor-exit p0
    ...
    const-string/jumbo v19, "onUpdateUiccStatus(): Number of apps : "
    ...
    invoke-virtual {v5}, Lcom/android/internal/telephony/CardSubscriptionManager$CardInfo;->getIccId()Ljava/lang/String;
    ...
    const-string/jumbo v19, "onUpdateUiccStatus(): mCardSubData["
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/internal/telephony/SubscriptionData;->getIccId()Ljava/lang/String;
    ...
    const-string/jumbo v19, "onUpdateUiccStatus(): New card, update card info at index = "
    ...
    new-instance v20, Lcom/android/internal/telephony/SubscriptionData;

    move-object/from16 v0, v20

    invoke-direct {v0, v12}, Lcom/android/internal/telephony/SubscriptionData;-><init>(I)V
    ...
    .line 522
    .local v9, cardSub:Lcom/android/internal/telephony/Subscription;
    ...
    iput v0, v9, Lcom/android/internal/telephony/Subscription;->slotId:I
    ...
    iput-object v0, v9, Lcom/android/internal/telephony/Subscription;->appId:Ljava/lang/String;
    ...
    iput-object v0, v9, Lcom/android/internal/telephony/Subscription;->appLabel:Ljava/lang/String;
    ...
    iput-object v0, v9, Lcom/android/internal/telephony/Subscription;->iccId:Ljava/lang/String;
    ...
    invoke-direct {v0, v14}, Lcom/android/internal/telephony/CardSubscriptionManager;->appTypetoString(Lcom/android/internal/telephony/IccCardApplicationStatus$AppType;)Ljava/lang/String;
    ...
    .line 536
    iput-object v13, v9, Lcom/android/internal/telephony/Subscription;->appType:Ljava/lang/String;
    ...
    invoke-direct {v0, v1}, Lcom/android/internal/telephony/CardSubscriptionManager;->loge(Ljava/lang/String;)V
    ...
    invoke-direct {v0, v9, v4}, Lcom/android/internal/telephony/CardSubscriptionManager;->fillAppIndex(Lcom/android/internal/telephony/Subscription;I)V
    ...
    iput-object v0, v9, Lcom/android/internal/telephony/Subscription;->appType:Ljava/lang/String;

    .line 539
    const-string/jumbo v18, "onUpdateUiccStatus(): UNKNOWN APP"
    ...
    .end local v5           #cardInfo:Lcom/android/internal/telephony/CardSubscriptionManager$CardInfo;
    ...
    .end local v9           #cardSub:Lcom/android/internal/telephony/Subscription;
    ...
    .restart local v5       #cardInfo:Lcom/android/internal/telephony/CardSubscriptionManager$CardInfo;
    ...
    .restart local v17       #usersub:Lcom/android/internal/telephony/SubscriptionData;
    :catch_0
    move-exception v10

    .line 576
    .local v10, e:Ljava/lang/Exception;
    const-string/jumbo v18, "matchSubscriptions failure"
    ...
    invoke-direct {v0, v1}, Lcom/android/internal/telephony/CardSubscriptionManager;->notifyCardInfoAvailable(I)V
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/internal/telephony/CardSubscriptionManager;->notifyCardInfoNotAvailable(ILcom/android/internal/telephony/MSimConstants$CardUnavailableReason;)V
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/CardSubscriptionManager;->mAllCardsInfoAvailable:Z
    ...
    iput-boolean v0, v1, Lcom/android/internal/telephony/CardSubscriptionManager;->mAllCardsInfoAvailable:Z
