...
.method public updateSpnDisplay()V
    ...
    .line 651
    :goto_1
    new-instance v17, Lcom/android/internal/telephony/PlmnConstants;

    move-object/from16 v0, v17

    invoke-direct {v0, v3}, Lcom/android/internal/telephony/PlmnConstants;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v9, v8}, Lcom/android/internal/telephony/PlmnConstants;->getPlmnValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v11

    .line 654
    .local v11, plmnValue:Ljava/lang/String;
    if-eqz v11, :cond_0
    ...
    const-string/jumbo v17, "ro.config.hw_opta"
    ...
    const-string/jumbo v17, "ro.config.hw_optb"
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/android/internal/telephony/IccRecords;->getOperatorNumeric()Ljava/lang/String;

    move-result-object v5

    .line 698
    .local v5, hplmn:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 700
    .local v12, regplmn:Ljava/lang/String;
    invoke-virtual {v2, v5, v12}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker$CustPlmnMember;->acquireFromProperty(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 701
    iget-boolean v15, v2, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker$CustPlmnMember;->showSpn:Z

    .line 702
    iget-boolean v14, v2, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker$CustPlmnMember;->showPlmn:Z

    .line 703
    iget v13, v2, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker$CustPlmnMember;->rule:I

    .line 704
    iget-object v10, v2, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker$CustPlmnMember;->plmn:Ljava/lang/String;
    ...
    .end local v5           #hplmn:Ljava/lang/String;
    .end local v12           #regplmn:Ljava/lang/String;
    :cond_5
    ...
    invoke-virtual {v6, v0, v15}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;
    ...
    const-string v17, "android.intent.action.ACTION_DSDS_GSM_OPERATOR_CHANGED"
    ...
    .line 726
    .local v7, intentg:Landroid/content/Intent;
    const/high16 v17, 0x2000
    ...
    .end local v7           #intentg:Landroid/content/Intent;
    ...
    .end local v11           #plmnValue:Ljava/lang/String;
    :cond_7
    const/4 v13, 0x2
    ...
    const-string/jumbo v18, "mIccRecords null while updateSpnDisplay was called."
    ...
    const-string v18, "Exception when got data value"
    ...
    .restart local v8       #languageCode:Ljava/lang/String;
    .restart local v11       #plmnValue:Ljava/lang/String;
    :cond_8
    move-object/from16 v0, p0
