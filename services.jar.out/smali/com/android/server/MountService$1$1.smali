...
.method public run()V
    ...
    #getter for: Lcom/android/server/MountService;->mHasSwitchFunction:Z
    ...
    const-string v10, "persist.sys.main_storage"
    ...
    #calls: Lcom/android/server/MountService;->isPrimaryVolumeMounted()Z
    ...
    const-string v10, "external sdcard is primary but external sdcard not found, send a broadcast "
    ...
    const-string v10, "android.intent.action.PRIMARY_SD_NOT_EXISTS"
    ...
    invoke-static {v9, v10, v11}, Lcom/android/server/MountService;->access$1400(Lcom/android/server/MountService;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_5
