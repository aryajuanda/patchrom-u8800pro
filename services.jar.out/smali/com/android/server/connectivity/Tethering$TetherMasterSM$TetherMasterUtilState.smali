...
.method protected chooseUpstreamType(Z)V
    ...
    .line 1533
    .local v8, netType:Ljava/lang/Integer;
    const-string v12, "Tethering"
    ...
    .end local v8           #netType:Ljava/lang/Integer;
    :catchall_0
    move-exception v12
    ...
    .line 1541
    .restart local v8       #netType:Ljava/lang/Integer;
    const-string v12, "Tethering"
    ...
    .line 1550
    .local v6, isV6Connected:Z
    :try_start_2
    invoke-virtual {v8}, Ljava/lang/Integer;->intValue()I

    move-result v12

    invoke-interface {v2, v12}, Landroid/net/IConnectivityManager;->getNetworkInfo(I)Landroid/net/NetworkInfo;
    ...
    invoke-interface {v2, v12}, Landroid/net/IConnectivityManager;->getLinkProperties(I)Landroid/net/LinkProperties;
    ...
    invoke-virtual {v0, v2, v9}, Lcom/android/server/connectivity/Tethering$TetherMasterSM$TetherMasterUtilState;->isIpv6Connected(Landroid/net/IConnectivityManager;Landroid/net/LinkProperties;)Z
    :try_end_2
    ...
    invoke-virtual {v0, v12}, Lcom/android/server/connectivity/Tethering$TetherMasterSM$TetherMasterUtilState;->addUpstreamV6Interface(Ljava/lang/String;)V

    .line 1562
    .end local v5           #info:Landroid/net/NetworkInfo;
    .end local v6           #isV6Connected:Z
    .end local v8           #netType:Ljava/lang/Integer;
    ...
    #getter for: Lcom/android/server/connectivity/Tethering;->mPreferredUpstreamMobileApn:I
    invoke-static {v12}, Lcom/android/server/connectivity/Tethering;->access$4800(Lcom/android/server/connectivity/Tethering;)I
    ...
    invoke-virtual {v12, v13, v14, v15}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->sendMessageDelayed(IJ)V
    ...
    invoke-virtual {v0, v4}, Lcom/android/server/connectivity/Tethering$TetherMasterSM$TetherMasterUtilState;->notifyTetheredOfNewUpstreamIface(Ljava/lang/String;)V
    ...
    invoke-static {v12, v7}, Lcom/android/server/connectivity/Tethering;->access$4900(Lcom/android/server/connectivity/Tethering;Landroid/net/LinkProperties;)Z
    ...
    .restart local v6       #isV6Connected:Z
    .restart local v8       #netType:Ljava/lang/Integer;
    .restart local v9       #props:Landroid/net/LinkProperties;
    :catch_1
    move-exception v12
